 ...
 * @version $Id: TopicOut.java,v 1.2 2003/07/27 10:43:49 chris Exp $
 */
public class TopicOut implements OutboundMessage
{
    private String channel, topic;

    public TopicOut(String channel, String topic) {
