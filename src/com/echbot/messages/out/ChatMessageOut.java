 ...
 * @version $Id: ChatMessageOut.java,v 1.2 2003/07/27 10:43:49 chris Exp $
 */
public class ChatMessageOut implements OutboundMessage
{
    private String to, message;
    private boolean privmsg;

    public ChatMessageOut(String to, String message, boolean privmsg) {
        this.to = to;
    ...
    public String toSendString() {
        return (privmsg ? "PRIVMSG " : "NOTICE ") + to + " :" + message;
    }
