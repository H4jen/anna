 ...
 * @version $Id: UnknownIn.java,v 1.2 2003/07/27 10:43:49 chris Exp $
 */
public class UnknownIn implements InboundMessage
{
    private static final Logger log = Logger.getLogger(UnknownIn.class);
    private String line;

    public UnknownIn(String line) {
        log.info("Unknown msg: " + line);
        this.line = line;
    }
